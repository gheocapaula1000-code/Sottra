...
const plans = [
  ...
  },
  {
    ...
    price: 799,
    period: "/mese",
    description: "Per fondi immobiliari e società di valutazione.",
    scans: "Scansioni illimitate",
    ...
    <footer className="border-t border-border px-6 py-10 sm:px-10 lg:px-20">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 text-center">
        ...
        <p className="text-[11px] text-muted-foreground/60">
          Documento riservato — Piani definitivi con fonti dati reali certificate — Marzo 2026
        </p>
      </div>
    </footer>
  );
