...
const STORAGE_KEY = "sottra_cookie_consent";
...
export default function CookieBanner() {
  ...
  const accept = () => {
    try { localStorage.setItem(STORAGE_KEY, "true"); } catch { /* localStorage non disponibile */ }
    setVisible(false);
  };

  return (
    <div data-capture-hide className="fixed bottom-0 left-0 right-0 z-[9999] border-t border-border bg-card/95 backdrop-blur-sm px-4 py-4 pb-safe shadow-lg">
